...
$(function () {
  ...
  if (typeof Chart !== 'undefined') {
    ...
    if ($("#liteLineChart").length) {
      ...
      if ($("#chartPeakTime").length) {
        var lineChartPeak = $("#chartPeakTime");
          var lineData = {
        labels: ["12:00", "Mon 12/Jun", "12:00", "Tue 13/Jun", "12:00", "Wed 14/Jun", "12:00", "Thu 15/Jun","12:00", "Mon 12/Jun", "12:00", "Tue 13/Jun", "12:00", "Wed 14/Jun", "12:00", "Thu 15/Jun"],
        datasets: [{
          label: "Total Post",
          fill: false,
          lineTension: 0,
          ...
          pointRadius: 6,
          pointHitRadius: 10,
          data: [27, 26,26, 44, 24, 29, 22, 43, 52,27, 20, 44, 24, 29, 22, 43, 52],
          spanGaps: false,
          showLine:false
        }]
      };
      ...
      // line chart init
      var myLineChart = new Chart(lineChartPeak, {
        type: 'line',
        data: lineData,
        options: {
          legend: {
    ...
    if ($("#donutChart").length) {
      ...
      var data = {
        ...
        datasets: [{
          data: [300, 50, 100],
          backgroundColor: ["#d97b70", "#6896f9", "#85c751"],
          hoverBackgroundColor: ["#d97b70", "#6896f9", "#85c751"],
          borderWidth: 0
        }]
      };
