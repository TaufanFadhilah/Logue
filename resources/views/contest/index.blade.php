  ...
  <div class="row">
    @foreach ($contests as $key => $contest)
      <div class="col-md-4 mt-3 mb-3">
        <div class="card">
          <center><img class="card-img-top" src="{{asset('storage/'.$contest->poster)}}" style="max-height: 200px;"></center>
          <div class="card-body">
            ...
            <p class="card-text"><small class="text-muted">Last updated {{$contest->updated_at}}</small></p>
          </div>
        </div>
      </div>
    @endforeach
